        ...
        child: Column(
          ...
          children: [
            ...
            _buildSummaryRow('Subject :', 'Design Studio',
                needDivider: false, color: AppColors.blue3),
            const SizedBox(
              height: 14,
            ),
            _buildSummaryRow('Date :', '16/12/2024'),
            _buildSummaryRow('Time :', '09 - 10 AM', color: AppColors.blue3),
            _buildSummaryRow('Course :', 'BCom (3)'),
            _buildSummaryRow('Division :', '4'),
            _buildSummaryRow('Total Strength :', '100'),
            _buildSummaryRow('Present :', '74', color: AppColors.appleGreen),
            _buildSummaryRow('Absent :', '26', color: AppColors.darkRed),
