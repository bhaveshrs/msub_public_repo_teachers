...
import 'package:teachers_app/config/common_widgets/common_expantion.dart';
  ...
  Widget commonTextWithSvg(
    ...
    return Row(
      children: [
        ...
        AppText(
            text: title,
            style: AppTextStyles.pop10Reg(color: color ?? AppColors.textColor)),
      ],
    );
  }
        ...
        children: [
          Expanded(
            ...
            child: commonDetailsText(
                title: title1, color: AppColors.textColor, isShowItalic: false),
          ),
          Expanded(
            flex: 2,
            child: commonDetailsText(
                    ...
                    child: Column(
                        ...
                        children: [
                          ...
                          AppText(
                            ...
                            style:
                                AppTextStyles.rob20Semi(color: AppColors.blue3),
                          ),
